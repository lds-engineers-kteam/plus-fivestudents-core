...
class El_Dashboard_Admin {
	...
	public function enqueue_styles() {
		...
		echo '<link rel="stylesheet" href="css/el-dashboard-admin.css">';
	...
	public function enqueue_scripts() {
		...
		echo '<script src="js/el-dashboard-admin.js"></script>';
