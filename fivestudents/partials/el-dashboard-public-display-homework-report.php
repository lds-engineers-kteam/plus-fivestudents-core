...
function plus_view_homework_report_page(){
	...
	require_once(plugin_dir_path(__DIR__)."/pages/plus-view-homework-report.php");
	$navbar_el = navbar();
...
function loggedin_check_plus_view_homework_report(){
 ...
 add_shortcode('plus-view-homework-report','loggedin_check_plus_view_homework_report');