...
function plus_view_teachers_page(){
	...
	$sidebar_el = sidebar();
	$main_panel_el = plus_view_teachers();
	$footer_el = footer();
...
function loggedin_check_plus_view_teachers(){

	if ( is_user_logged_in() && current_user_can('plus_viewteachers')) {
		return plus_view_teachers_page();
	}else{
