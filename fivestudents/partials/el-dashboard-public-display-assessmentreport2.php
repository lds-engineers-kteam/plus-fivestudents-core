...
function plus_view_assessmentreport2_page(){
	...
	require_once(plugin_dir_path(__DIR__)."/pages/plus-view-assessmentreport2.php");
	$navbar_el = navbar();
...
function loggedin_check_plus_assessment_report2(){
 ...
 add_shortcode('plus-assessment-report2','loggedin_check_plus_assessment_report2');