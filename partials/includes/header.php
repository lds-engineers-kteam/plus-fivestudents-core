...
function main_header() {
  ...
  // <script type="text/javascript" src="'.$CFG->wwwroot.'/js/clipboard.js"></script>
  // <script type="text/javascript" src="'.$CFG->wwwroot.'/vendors/clipboard/clipboard.min.js"></script>
