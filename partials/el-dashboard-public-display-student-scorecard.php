...
function plus_view_student_scorecard_page(){
	...
	$sidebar_el = sidebar();
	$main_panel_el = plus_view_student_scorecard();
	$footer_el = footer();
...
function loggedin_check_plus_view_student_scorecard(){

	if ( is_user_logged_in() && current_user_can('manage_plusstudentscorecard')) {
		return plus_view_student_scorecard_page();
	}else{
